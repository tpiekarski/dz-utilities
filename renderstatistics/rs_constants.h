...
#define RS_DEFAULT_SCALING_ALGORITHM Qt::TransformationMode::FastTransformation
...
#define RS_SCALING_FAST_TRANSFORMATION "FastTransformation"
#define RS_SCALING_SMOOTH_TRANSFORMATION "SmoothTransformation"
#define RS_SETTINGS_DIALOG_MARGIN 5
#define RS_SETTINGS_DIALOG_SPACING RS_SETTINGS_DIALOG_MARGIN
